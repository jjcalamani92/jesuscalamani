...
export  function Post0(props: Props) {
  const { post } = props
  return (
    <article className="max-w-2xl px-6 py-24 mx-auto space-y-10">
      <div className="w-full mx-auto space-y-8 text-center">
        ...
        <div className="flex flex-col items-start justify-between w-full md:flex-row md:items-center dark:text-gray-400">
          <div className="flex items-center md:space-x-2">
            ...
            /> */}
            <p className="text-sm"> July 19th, 2021</p>
          </div>
      ...
      <div className="prose max-w-none prose-pre:bg-transparent prose-pre:p-0">
        ...
        <ReactMarkdown rehypePlugins={[rehypeRaw]} remarkPlugins={[remarkGfm]} children={post.data.content} />
