              ...
              <div className="flex flex-col items-start xl:justify-start 2xl:justify-end xl:px-0 px-4">
                ...
                <div className="w-full 2xl:w-8/12 mt-3">
                  ...
                  <div className="mt-4 md:mt-8">
                    ...
                    <textarea className="mt-3 text-base border-2 w-11/12 lg:w-full xl:w-10/12 resize-none hover:border-indigo-600 focus:border-indigo-600 focus:outline-none border-black xl:h-40 py-5 pl-4 text-gray-800"  placeholder="Write us something..." defaultValue={""} />
                  </div>
                  <div className="py-5">
